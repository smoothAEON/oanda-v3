...
def _load_smc_module() -> Any:
    ...
    except ModuleNotFoundError as exc:  # pragma: no cover - exercised through tests
        raise RuntimeError(
            "smartmoneyconcepts is not installed. Install it with "
...
class SmcAdapter:
    ...
    def _build_zone_summary(
        ...
        selected_candidates: list[OrderBlockCandidate] = []
        mitigated_count = 0
        unmitigated_count = 0
