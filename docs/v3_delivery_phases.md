...
- The instrument registry is the single source of truth for all 16 scan instruments: `XAU_USD`, `SPX500_USD`, `XAG_USD`, `EUR_USD`, `GBP_USD`, `USD_JPY`, `AUD_USD`, `USD_CAD`, `USD_CHF`, `NZD_USD`, `EUR_GBP`, `EUR_JPY`, `GBP_JPY`, `BCO_USD`, `WTICO_USD`, `JP225_USD`. Unknown instruments must fail loudly. Source anchors: Sections 1.5, 5.3, 8.
