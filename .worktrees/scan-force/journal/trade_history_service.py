...
class TradeHistoryService:
    ...
    def get_trade_history(
        ...
        pnl = self.compute_realized_pnl(period, instrument=instrument)
        ...
        return TradeHistoryPage(
            ...
            summary=pnl,
            rows=tuple(filtered_rows[start_index:end_index]),
            page=resolved_page,
    ...
    def compute_realized_pnl(
        ...
        window = self.resolve_period_window(period, tz_name=self.settings.journal_timezone)
    ...
    def _project_trade_record(self, trade_id: str) -> bool:
        ...
        closed_record = TradeRecord(
            ...
            close_reason=self._map_close_reason(final_close_event.reason),
            pips=weighted_pips,
    ...
    def _resolve_pip_size(instrument: str) -> Decimal | None:
        try:
            return Decimal(str(get_instrument_spec(instrument).pip_size))
        except KeyError:
            pass
    ...
    @staticmethod
    def _map_close_reason(raw_reason: str | None) -> CloseReason:
