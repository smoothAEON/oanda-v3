...
class PriceStreamTask:
    ...
    def __init__(
        ...
        *,
        ...
        resolved_queue_maxsize = max(int(queue_maxsize), len(self.settings.stream_instruments), 1)
        self._queue_states = {
    ...
    async def start(self) -> None:
        ...
        self.logger.info(
            ...
            instruments=tuple(self.settings.stream_instruments),
    ...
    async def _run_stream(self) -> None:
        ...
        while not self._stop_event.is_set():
            try:
                async for event in self.stream_client.stream_prices(self.settings.stream_instruments):
