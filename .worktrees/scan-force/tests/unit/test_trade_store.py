...
from core.enums import ChartMode, ChartRenderStyle, IndicatorKind, RuntimeConfigKey, TimeAlertKind, TimeAlertStatus, TradeState
...
class TestStage10Collections:
    ...
    def test_record_signal_and_recent_spreads_round_trip(self, store: TradeStore) -> None:
        ...
        assert spreads[0]["is_spiking"] is True
...
def test_trade_store_degrades_gracefully_when_tinydb_open_fails(
    ...
    assert store.record_spread("EUR_USD", 0.4, False) == 0
