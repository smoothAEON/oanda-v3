...
def _normalize_currency(value: str | None) -> str | None:
    ...
    if not normalized:
        raise ValueError("account_currency must be a non-empty string when provided.")
    return normalized
...
class PriceTick:
    ...
    def __post_init__(self) -> None:
        object.__setattr__(self, "instrument", validate_live_instrument(self.instrument))
...
class TradeOpenedEvent:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(self, "account_currency", _normalize_currency(self.account_currency))
